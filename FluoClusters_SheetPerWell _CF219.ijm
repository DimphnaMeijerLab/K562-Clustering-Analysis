...
for (j=1; j<2; j++){
for (i=1;i<6;i++){
open("O:/CF217-217-219_N1-N3/GFP/CF219_20hEP_"+j+"__000"+i+"_GFP.tiff");
...
selectWindow("CF219_20hEP_"+j+"__000"+i+"_GFP.tiff");
...
//roiManager("Show All");
//roiManager("Measure");
close("CF219_20hEP_"+j+"__000"+i+"_GFP.tiff");
//close("CF151_"+j+"_24hClustering_000"+i+"_RFP.tiff");
//close("Composite (RGB)");
roiManager("Delete");
}
saveAs("Results", "O:/CF217-217-219_N1-N3/GFP/CF219_A0B0_20hClustering_GFP.csv");
run("Clear Results");
//}
